...
// POST /api/invoices/sale/[id]/cancel - Cancel sale invoice
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json({ success: false, error: "Failed to cancel sale invoice" }, { status: 500 })
  }
}
